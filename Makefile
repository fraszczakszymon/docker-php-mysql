...
run:
	...
	@docker run -p $(port):80 -v $(CURDIR):/var/www:rw --name $(project) -d webapp /sbin/my_init --enable-insecure-key
	...
	@echo "\033[0;32m   - Localhost:\t\t\033[1;32mlocalhost:"$(port)"\033[0m"
